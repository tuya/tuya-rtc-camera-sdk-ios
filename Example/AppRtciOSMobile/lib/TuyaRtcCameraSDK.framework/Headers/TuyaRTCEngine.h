...
/**
 * This function is called when the engine need output the runtime log
 * @param message Content of the log
 */
-(void) didLogMessage:(NSString*) message;
/**
 * This function is called when the engine has been initialized successfully
 */
-(void) didInitalized;
/**
 * This function will be called when the engine has been destroyed successfully
 */
-(void) didDestroyed;
