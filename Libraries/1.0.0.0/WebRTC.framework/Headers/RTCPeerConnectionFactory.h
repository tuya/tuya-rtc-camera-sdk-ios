...
@protocol AudioDeviceDataDelegate <NSObject>
-(void) didCaptureDataWithBuffer:(void*)audioData
...
-(void) didRenderDataWithBuffer:(void*)audioData
                     andSamples:(NSInteger)samples
              andBytesPerSample:(NSInteger)bytesPerSample
                    andChannels:(NSInteger)channels
               andSamplesPerSec:(NSInteger)samplesPerSec;
...
/* Initialize object with injectable video encoder/decoder factories and audio device data observer*/
- (instancetype)initWithEncoderFactory:(nullable id<RTC_OBJC_TYPE(RTCVideoEncoderFactory)>)encoderFactory
                        decoderFactory:(nullable id<RTC_OBJC_TYPE(RTCVideoDecoderFactory)>)decoderFactory
                   audioDeviceDelegate:(nullable id<RTC_OBJC_TYPE(AudioDeviceDataDelegate)>)delegate;
...
@property(nonatomic, weak, nullable) id<AudioDeviceDataDelegate> delegate;
